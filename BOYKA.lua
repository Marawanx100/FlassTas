...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BOYKA-TEAM/Files_Boyka/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1186900224,1404245786,1590091397,1032413864}   
...
os.execute('wget https://raw.githubusercontent.com/BOYKA-TEAM/BOYKA/main/BOYKA.lua')
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'BOYKA_MOD')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOYKA_MOD')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOYKA_MOD')..') \n ❃∫ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/BOYKA_MOD)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/BOYKA_MOD)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫
 ❃∫ ↬𝐍𝐀𝐒𝐀 𝐓𝐄𝐀𝐌
≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫
 ❃∫ ↬[Information](t.me/NASA500)
≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/b_a_n_d_a_1_5)
≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/Elkomanda_Ya)
 ≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/B_O_Y_K_A_A)
 ≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOYKA_MOD')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BOYKA_MOD')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BOYKA-TEAM/Files_Boyka/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بويكا\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس بويكا ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/BOYKA_MOD) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/BOYKA-TEAM/Files_Boyka/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOYKA_MOD')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOYKA_MOD')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BOYKA_MOD')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'BOYKA:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'BOYKA:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."BOYKA:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."BOYKA:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "❃∫ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."BOYKA:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."BOYKA:allM"..msg.chat_id_)
...
if database:get(bot_id.."BOYKA:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'BOYKA:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,BOYKA)
x = 0
tags = 0
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BOYKA_MOD')..')'
local iduser = result.sender_user_id_
...
local BOYKA = ' ❃∫ عدد الادمنيه : '..data.administrator_count_..
'\n\n ❃∫ عدد المطرودين : '..data.kicked_count_..
'\n\n ❃∫ عدد الاعضاء : '..data.member_count_..
'\n\n ❃∫ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n ❃∫  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, BOYKA) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,BOYKA,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (BOYKA.total_count_ or 0)
...
local rdphoto = BOYKAa[math.random(#BOYKAa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, BOYKA.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
BOYKA = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,BOYKA)  
...
BOYKA = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,BOYKA)  
...
*❃م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫ٴ
彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/BOYKA_MOD)➢ 
]]
...
database:set(bot_id.." BOYKA:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'❃∫ تم تفعيل الزخرفه')
database:set(bot_id.." BOYKA:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.." BOYKA:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝐍𝐀𝐒𝐀━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/BOYKA_MOD)➢ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '❃∫ تم تعطيل الابراج')
database:set(bot_id.." BOYKA:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'❃∫ تم تفعيل الابراج')
database:set(bot_id.." BOYKA:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." BOYKA:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." BOYKA:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '❃∫ تم تعطيل حساب العمر')
database:set(bot_id.." BOYKA:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." BOYKA:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." BOYKA:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BOYKA:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'❃∫ تم تفعيل الافلام')
database:set(bot_id.."BOYKA:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."BOYKA:movie_bot"..msg.chat_id_) == "open" then
