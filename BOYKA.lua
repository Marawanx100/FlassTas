...
if tonumber(user_id) == tonumber(1417804968) then  
var = 'انت مبرمج السورس روح قلبي🤩🙄ي'
elseif tonumber(user_id) == tonumber(1151371484) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1186900224) then
var = 'فلسطس الهكر'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'انت مطور يابا على عينى وعلى راسى❤️🙄'  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'انت مطور يابا على عينى وعلى راسى❤️🙄'  
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'انت هنا منشئ اساسي يعنى اعلى رتبه عايزك تفتخر❤️😉'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
么 [𝑨𝑺𝑲 𝑻𝑶 𝑴](http://t.me/FlassTas4_bot) 
么 [𝐅𝐋𝐀𝐒𝐒𝐓𝐀𝐒] (http://t.me/UU_Fs)
么 [𝐌𝐀𝐍𝐃𝐎](http://t.me/Mdo_Fs)
╰──── • ◈ • ────╯ 
...
local rtp = anamen(user_id,chat_id)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext =  \n⌔︙ العضو » [ ..data.first_name_.. ](t.me/ ..(data.username_ or  hacker ).. )  
...
send(msg.chat_id_, msg.id_,Text) 
 ...
 text == 'رابط الحذف' or text == 'رابط حذف' then
t =[[
