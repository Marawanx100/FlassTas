...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Alamy300/FlassTas/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1417804968,1186900224,1151371484}   
...
if tonumber(user_id) == tonumber(1417804968) then  
var = true  
elseif tonumber(user_id) == tonumber(1186900224) then
var = true  
elseif tonumber(user_id) == tonumber(1151371484) then
var = true
...
send(msg.chat_id_, msg.id_,' ◈ تم تحديث السورس \n ◈ لديك اخر اصدار لسورس الهكر\n ◈ الاصدار > { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ◈' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◈ اصدار سورس الهكر \n ◈ الاصدار >{ 1.3v}')
end
if text == 'قناه تحديثات البوت ◈' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◈ [تحديثات البوت](t.me/FlassTas10) \n ◈ [قناه السورس](t.me/SourceHacker)')
end
...
usertext = '\n ◈ العضو > ['..result.title_..'](t.me/'..(username or 'SourceHacker')..')'
status  = '\n ◈ تم ترقيته مطور'
...
usertext = '\n ◈ العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceHacker')..')'
status  = '\n ◈ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◈ العضو > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceHacker')..') \n ◈ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◈ العضو : {["..data.first_name_.."](T.ME/SourceHacker)}\n ◈ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◈ عذرا > {["..data.first_name_.."](T.ME/SourceHacker)}\n ◈ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
⚡> 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐇𝐀𝐂𝐊𝐄𝐑 🦅
  ──────── ◈ ──────── 
⚡↬ [𝐈𝐍𝐒𝐓𝐀𝐋𝐋 𝐒𝐎𝐔𝐑𝐂𝐄 🦅](https://t.me/FlassTas10)
 
⚡↬ [𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 🦅](http://t.me/SourceHacker)
 
⚡↬ [𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 𝐒𝐎𝐔𝐑𝐂𝐄 🦅](https://t.me/UU_Fs)
 
⚡↬ [𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 𝐒𝐎𝐔𝐑𝐂𝐄 🦅](http://t.me/Mdo_Fs) 
 ──────── ◈ ────────
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◈ بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceHacker')..') \n ◈ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◈ بواسطه > ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceHacker')..') \n ◈ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Alamy300/FlassTas/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◈ اهلا بك في متجر ملفات الهكر\n ◈ ملفات السورس ↓\n么 ◈𝗛𝗔𝗖𝗞𝗘𝗥◈么\n\n"
local TextE = "\n么 ◈𝗛𝗔𝗖𝗞𝗘𝗥◈么\n ◈ علامة تعني { ✓ } ملف مفعل\n ◈ علامة تعني { ✘ } ملف معطل\n ◈ قناة سورس الهكر ↓\n".." ◈ [اضغط هنا لدخول](t.me/SourceHacker) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Alamy300/FlassTas/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_," ◈ عذرا الملف لايدعم سورس الهكر \n") 
end
return false
end
...
local UserName = (b.username_ or "SourceHacker")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◈ لعضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceHacker')..')'
status  = '\n ◈ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◈ العضو > '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◈ العضو > ['..result.title_..'](t.me/'..(text1[3] or 'SourceHacker')..')'..'\n ◈ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الهكر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الهكر')
local BOYKA_Msg = {
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الهكر').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceHacker')..')'
local iduser = result.sender_user_id_
...
local amira = {
" ◈  عسل يا ناس😉💋",
" ◈ ما تجي نرتبط ونعمل واحد😹❤️",
" ◈ يتي كمليه😢❤️",
" ◈ مو حلو بي المره😕💔",
" ◈ قمر يا ناس😔💋",
" ◈ لا انته كده تخود بوسه🙂😹",
}
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n ◈ 𝒚𝒐𝒖𝒓 𝒊𝒅 > '..msg.sender_user_id_..'\n ◈ 𝒖𝒔𝒆𝒓𝒏𝒂𝒎𝒆 > '..username..'\n ◈ 𝒔𝒕𝒂𝒕𝒔 > '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ◈ 𝒚𝒐𝒖𝒓 𝒔𝒊𝒕𝒆 > '..rtpa..'\n ◈ 𝒚𝒐𝒖𝒓 𝒊𝒏𝒕𝒆𝒓𝒂𝒄𝒕𝒊𝒐𝒏 > '..Total_Msg(Msguser)..'\n ◈ 𝒚𝒐𝒖𝒓 𝒎𝒆𝒔𝒔𝒂𝒈𝒆𝒔 > '..Msguser..'\n ◈ 𝒚𝒐𝒖𝒓 𝒆𝒏𝒈𝒂𝒈𝒆𝒎𝒆𝒏𝒕 𝒓𝒂𝒕𝒆 > '..string.sub(nspatfa, 1,5)..' %\n ◈ 𝒕𝒉𝒆 𝒑𝒂𝒘𝒔 > '..edit..'\n ◈ 𝒚𝒐𝒖𝒓 𝒑𝒐𝒊𝒏𝒕𝒔 > '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n ◈ 𝒚𝒐𝒖𝒓 𝒊𝒅 > '..msg.sender_user_id_..'\n ◈ 𝒖𝒔𝒆𝒓𝒏𝒂𝒎𝒆 > '..username..'\n ◈ 𝒔𝒕𝒂𝒕𝒔 > '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ◈ 𝒚𝒐𝒖𝒓 𝒔𝒊𝒕𝒆 > '..rtpa..'\n ◈ 𝒚𝒐𝒖𝒓 𝒊𝒏𝒕𝒆𝒓𝒂𝒄𝒕𝒊𝒐𝒏 > '..Total_Msg(Msguser)..'\n ◈ 𝒚𝒐𝒖𝒓 𝒎𝒆𝒔𝒔𝒂𝒈𝒆𝒔 > '..Msguser..'\n ◈ 𝒚𝒐𝒖𝒓 𝒆𝒏𝒈𝒂𝒈𝒆𝒎𝒆𝒏𝒕 𝒓𝒂𝒕𝒆 > '..string.sub(nspatfa, 1,5)..' %\n ◈ 𝒕𝒉𝒆 𝒑𝒂𝒘𝒔 > '..edit..'\n ◈ 𝒚𝒐𝒖𝒓 𝒑𝒐𝒊𝒏𝒕𝒔 > '..NUMPGAME..']\n')
else
...
⚡ م3 » اوامر الادمنيه
⚡ م4 » اوامر المدراء
⚡ م5 » اوامر تنزيل وي الرفع
⚡ م6 » اوامر المجموعه
⚡ م7 » اوامر التسليه
⚡ م8 » اوامر مطور الاساسي
ٴ━  ━ ━ ━ ━ ━ ━ ━ ━
么 .[ٴ ◈𝗛𝗔𝗖𝗞𝗘𝗥◈么](t.me/SourceHacker)➢ 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ◈ٴ么 ◈𝗛𝗔𝗖𝗞𝗘𝗥◈么ٴ◈○ٴ\n◈ 彡 .[𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙰𝚂𝚃 𖤐](t.me/SourceHacker)➢ ')
end
...
local ytddl = https.request('https://mode-dev.tk/tg/search.php?search='..URL.escape(Ttext))
...
if k == 1 then
local msgin = msg.id_/2097152/0.5 
https.request('https://mode-dev.tk/tg/search.php?url='..v.url..'&token='..token..'&chat='..msg.chat_id_..'&type=ogg&msg='..msgin)
end
end
end
if text and text:match('^(.*) !$') and not database:get(bot_id..'dw:bot:api'..msg.chat_id_) then            
...
if k == 1 then
local msgin = msg.id_/2097152/0.5 
https.request('https://mode-dev.tk/tg/search.php?url='..v.url..'&token='..token..'&chat='..msg.chat_id_..'&type=mp4&msg='..msgin)
end
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الهكر')
