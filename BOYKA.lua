...
while(true) do
rm -fr ../.telegram-cli
screen -S FlassTas -X kill
screen -S FlassTas ./FlassTas
done
]])  
file:close() 
...
CPUPer=`FlassTas -b -n1 | grep "Cpu(s)" | awk '{print $2 + $4}'`
...
local inline = {
{{text="- 么𝗙𝗟𝗔𝗦𝗦𝗧𝗔𝗦 ",url="t.me/UU_Fs"}},
{{text="- 么𝗠𝗔𝗡𝗗𝗢 ",url="t.me/Mdo_Fs"}},
{{text="- 么【 ◈𝗛𝗔𝗖𝗞𝗘𝗥◈】 ",url="t.me/SourceHacker"},
{text="- 么𝙋𝙍𝙊𝙂𝙍𝘼𝙈𝙎 ",url="t.me/FlassTas10"},
{text="- 么𝘼𝙎𝙆 𝙏𝙊 𝙈𝙀 ",url="t.me/FlassTas4_bot"}}
}
send_inline(msg.chat_id_,'么【◈𝗛𝗔𝗖𝗞𝗘𝗥◈】么\n نحن نعشق الهكر وانتم تعشقون النساء ↯ ،',nil,inline) 
return false 
end
--------------------------------------------------------------------------------------------------------------
...
local inline = {
{{text="- ↺𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 ",url="https://my.telegram.org/auth?to=delete"},
{text="- ↺𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠 ",url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"}},
{{text="- ↺𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 ",url="https://www.facebook.com/help/deleteaccount"},
{text="- ↺𝗦𝗡𝗔𝗣𝗖𝗛𝗔𝗧 ",url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},
{{text="- ↺𝘼𝙎𝙆 𝗠𝗘 ",url="t.me/FlassTas4_bot"}}
}
send_inline(msg.chat_id_,'⚶مرحبا بك في سورس كوين┋ ،\n⚶اضغط على الازرار بالاسفل ⬇↯ ،',nil,inline) 
return false 
end
