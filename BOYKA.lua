...
sudo_users = {SUDO,1590091397,1032413864,1404245786,1186900224}   
...
var = true  
elseif tonumber(user_id) == tonumber(1032413864) then
var = true  
elseif tonumber(user_id) == tonumber(1404245786) then
var = true
elseif tonumber(user_id) == tonumber(1186900224) then
var = true
...
SourceBOYKAr = ' 么 اهلا عزيزي\n 么 انا بوت اسمي ' ..Namebot..'\n 么 اختصاصي حمايه الجروبات\n 么 من تكرار والسبام والتوجيه والخ…\n 么 لتفعيلي اتبع الاخطوات…↓\n 么 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط
end 
...
if text == 'معلومات السيرفر 么' and SudoBot(msg) then 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 么 [تحديثات البوت](t.me/barotlop) \n 么 [قناه السورس](t.me/NASA500)')
end
...
usertext = '\n 么 العضو » ['..result.title_..'](t.me/'..(username or 'NASA500')..')'
status  = '\n 么 تم ترقيته مطور'
...
usertext = '\n 么 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'NASA500')..')'
status  = '\n 么 تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 么 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NASA500')..') \n 么 '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 么 العضو : {["..data.first_name_.."](T.ME/NASA500)}\n 么 ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 么 عذرا » {["..data.first_name_.."](T.ME/NASA500)}\n 么 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
❈︎︎︎︎ 𝐒𝑂𝑈𝑅𝐶𝐸 𝐍𝐀𝐒𝐀
 ≪━━━━𑁍𝐍𝐀𝐒𝐀𑁍━━━━≫
✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶✶
   [𝑺𝑶𝑼𝑹𝑪𝑬 𝐍𝐀𝐒𝐀](https://t.me/NASA500)
☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 么 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NASA500')..') \n 么 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 么 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NASA500')..') \n 么 تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 么 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'NASA500')..')'
status  = '\n 么 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 么 العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 么 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'NASA500')..')'..'\n 么 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'NASA500')..')'
local iduser = result.sender_user_id_
